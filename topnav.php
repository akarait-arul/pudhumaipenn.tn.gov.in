	<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
		...
		<ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
			...
			<li class="nav-item dropdown">
				<a class="nav-link pe-0 ps-2 text-right" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
					<div class="bg-white dark__bg-1000 rounded-2 py-2">
						<span class="dropdown-item pointer-event" style="color:#64a6ff;">
							<?php
							echo isset($_SESSION['user_details']['login_names']) ? $_SESSION['user_details']['login_names'] : '';
							?>
						</span>
						<div class="dropdown-divider"></div>
                                                <a class="dropdown-item" onclick="get_userDetails()"  href="#">
			...
			$.ajax({
				...
				success: function(response) {
					...
					if (resdata['error_code'] == 200 && resdata['error_status']) {
						...
						$("#current_user_heading").html(' <span  style="color:#64a6ff"> ' + resdata.error_msg + ' </span> ');
