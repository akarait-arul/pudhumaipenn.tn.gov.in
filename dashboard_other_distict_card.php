<?php
$db_card_details = getDashboardDistrictCard($param);
?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="display-4 fs-1 fw-normal font-sans-serif text-primary count" data-countup="{&quot;endValue&quot;:23.434,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}">
                            <?php
                            //echo (isset($db_card_details['total_app_recd']) ? number_format($db_card_details['total_app_recd']) : 0);
                            echo $db_card_details['total_app_recd'] != 0 ? '<a href="get_institution_detail_list.php?type=' . base64_encode('appl') . '&dist_name=' . base64_encode('All') . '&dist=' . base64_encode($m_district_id) . '&inst_type=' . base64_encode('All') . '&callfor=' . base64_encode('Total Application Received') . '">' . number_format($db_card_details['total_app_recd']) . '</a>' : 0;
                            ?>
                        </div>
                    </div>
...
echo $db_card_details['total_pending'] != 0 ? '<a href="get_institution_detail_list.php?type=' . base64_encode('appl') . '&dist_name=' . base64_encode('All') . '&dist=' . base64_encode($m_district_id) . '&inst_type=' . base64_encode('All') . '&callfor=' . base64_encode('Total Pending Application') . '">' . number_format($db_card_details['total_pending']) . '</a>' : 0;
?>
                        </div>
                    </div>
                    <div class="card-footer m-0 text-right d-none">
...
echo $db_card_details['total_only_bank_pending'] != 0 ? '<a href="get_institution_detail_list.php?type=' . base64_encode('appl') . '&dist_name=' . base64_encode('All') . '&dist=' . base64_encode($m_district_id) . '&inst_type=' . base64_encode('All') . '&callfor=' . base64_encode('Only Bank Pending') . '">' . number_format($db_card_details['total_only_bank_pending']) . '</a>' : 0;
?>
                        </div>
                    </div>
                    <div class="card-footer m-0 text-right d-none">
...
echo (int) $db_card_details['total_inst'] != 0 ? '<a href="get_institution_detail_list.php?type=' . base64_encode('inst') . '&dist_name=' . base64_encode('All') . '&dist=' . base64_encode($m_district_id) . '&inst_type=' . base64_encode('All') . '&callfor=' . base64_encode('Total No of Institutions') . '">' . number_format($db_card_details['total_inst']) . '</a>' : 0;
?>
                        </div>
                    </div>
                    <div class="card-footer m-0 text-right d-none">
...
echo (int) $db_card_details['total_inst_not_logged_in'] != 0 ? '<a href="get_institution_detail_list.php?type=' . base64_encode('inst') . '&dist_name=' . base64_encode('All') . '&dist=' . base64_encode($m_district_id) . '&inst_type=' . base64_encode('All') . '&callfor=' . base64_encode('No of Institutions not logged in') . '">' . number_format($db_card_details['total_inst_not_logged_in']) . '</a>' : 0;
?>
                        </div>
                    </div>
                    <div class="card-footer m-0 text-right d-none">
