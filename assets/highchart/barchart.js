function generateColoumChart(result, gheading) {
    if (!result) {
        $("#registration-chart").html("<b>Data Not Found</b>");
        return false;
    }
    var _xaxis_data = [];
    ...
    $.each(result, function (index, value) {
        _xaxis_data.push(value.district_name);
    ...
    Highcharts.chart('registration-chart', {
         chart: {
            style: {
                fontFamily: 'Poppins'
            }
